...
class LCD_1inch14(framebuf.FrameBuffer):
    def __init__(self):
        ...
        self.spi = SPI(1,80000_000,polarity=0, phase=0,sck=Pin(SCK),mosi=Pin(MOSI),miso=None) #10000_000
    ...
    def write_cmd(self, cmd):
        ...
        self.dc(0)
        self.cs(0)
        self.spi.write(self.temp1) #(bytearray([cmd]))
        self.cs(1)
    ...
    def write_data(self, buf):
        ...
        self.dc(1)
        self.cs(0)
        self.spi.write(self.temp2) #(bytearray([buf]))
        self.cs(1)
